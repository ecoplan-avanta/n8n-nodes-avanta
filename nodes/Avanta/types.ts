...
export interface Company {
    ...
    internet?: string;
    logo?: string;
    extension_attributes?: CompanyExtensionAttributes;
}

export interface CompanyExtensionAttributes {
    external_company_customergroup_id: string;
    external_sales_org_id: string;
}
