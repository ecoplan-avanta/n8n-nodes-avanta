...
const properties: INodeProperties[] = [
        ...
        options: [
            {
                ...
                values: [
                    { displayName: 'Item Position', name: 'item_pos', type: 'number', required: true, default: 0, description: 'Position of the item in the backorder' },
                    ...
                    { displayName: 'Subtotal', name: 'subtotal', type: 'number', required: true, default: 0, description: 'Subtotal for the item' },
                    {
                        ...
                        options: [
                            ...
                            { displayName: 'Commission', name: 'commission', type: 'string', default: '', description: 'Commission information' },
                            ...
                            { displayName: 'Estimated Delivery Date', name: 'estimated_delivery_date', type: 'dateTime', default: '', description: 'Estimated delivery date for the item' },
                            {
    ...
    // Additional Fields
    {
        ...
        options: [
            ...
            { displayName: 'Billing Company', name: 'billing_company', type: 'string', default: '', description: 'Billing company' },
            ...
            { displayName: 'Billing Name', name: 'billing_name', type: 'string', default: '', description: 'Billing name' },
