...
const properties: INodeProperties[] = [
    ...
    {
        displayName: 'Customer Creditmemo ID',
        name: 'customer_creditmemoid',
        type: 'string',
        required: true,
        default: '',
        displayOptions: { show: { resource: ['creditmemos'], operation: ['create'] } },
        description: 'Creditmemo ID provided by the customer',
    },
    {
        displayName: 'Status',
        name: 'status',
        ...
        default: '',
        displayOptions: { show: { resource: ['creditmemos'], operation: ['create'] } },
        description: 'Status of the creditmemo',
    },
                ...
                values: [
													{
														...
														options: [
																	...
																	{
																		displayName: 'Creditmemo ID',
																		name: 'creditmemo_id',
																		type: 'number',
																		default: 0,
																		description: 'Internal creditmemo ID',
																	},
																	{
																		displayName: 'Creditmemo Item ID',
																		name: 'creditmemo_item_id',
																		type: 'number',
																		default: 0,
																		description: 'Internal creditmemo item ID',
																	},
																	{
													...
													},
													{
														...
														type: 'number',
															required:	true,
														default: 0,
														description: 'Position of the item in the creditmemo',
													},
													{
														displayName: 'Name',
														name: 'name',
    ...
    // Head-level document files
    {
        ...
        description: 'Creditmemo document files. You can add them manually or provide a JSON array.',
        displayOptions: { show: { resource: ['creditmemos'], operation: ['create'] } },
        options: [
            {
                displayName: 'Input Mode',
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            const report: CreditmemoReport = {
                ...
                customer_creditmemoid: this.getNodeParameter('customer_creditmemoid', i) as string,
