        ...
        options: [
            {
                ...
                values: [
                    { displayName: 'Item Position', name: 'item_pos', type: 'number', required: true, default: 0, description: 'Position of the item in the creditmemo' },
                    ...
                    { displayName: 'Subtotal', name: 'subtotal', type: 'number', required: true, default: 0, description: 'Subtotal for the item' },
                    {
                        ...
                        options: [
                            ...
                            { displayName: 'Creditmemo Item ID', name: 'creditmemo_item_id', type: 'number', default: 0, description: 'Internal creditmemo item ID' },
