...
const properties: INodeProperties[] = [
        ...
        options: [
            {
                ...
                values: [
                    { displayName: 'Item Position', name: 'item_pos', type: 'number', required: true, default: 0, description: 'Position of the item in the order' },
    ...
    // Additional Fields
    {
        ...
        options: [
            ...
            { displayName: 'Delivery Date', name: 'deliverydate', type: 'dateTime', default: '', description: 'Delivery date' },
            { displayName: 'Desired Delivery Date', name: 'desired_deliverydate', type: 'dateTime', default: '', description: 'Desired delivery date' },
